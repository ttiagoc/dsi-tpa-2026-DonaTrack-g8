...
- [ ] Refactorizar `EventoController` (Base path: `/donaciones/evento`)
...
- [ ] Refactorizar `MatchmakingController` (Base path: `/donaciones/matchmaking`)
...
- [ ] Refactorizar `CamionController` (Base path: `/logistica/camiones`)
...
- [ ] Refactorizar `EntregaDonacionesController` (Base path: `/logistica/entregas`)
  ...
  - Actualizar Controller y Service.
- [ ] Refactorizar `MonitoreoController` (Base path: `/logistica/monitoreo`)
...
- [ ] Refactorizar `PlanificacionRutasController` (Base path: `/logistica/planificacion`)
